...
public class StepDAG {
    ...
    public static class StepConfig {
        ...
        private Object params; // 步骤参数定义，可能是 List<Map> 或 Map
    ...
    public void addStep(String name, String displayName, String script, 
                        ...
                        Object params, Map<String, Object> startupProbe) {
    ...
    public void addStep(String name, String displayName, String script, 
        ...
        // resultCollector 默认与 resultParser 相同，确保结果会被收集
        config.setResultCollector(resultParser);
