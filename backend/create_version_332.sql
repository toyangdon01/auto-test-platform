-- Create script version for sol-network-config (script_id=332)
INSERT INTO script_versions (script_id, version, storage_path, entry_file, file_list, file_count, created_at)
VALUES (332, 'v1.0.0', 'C:/data/auto-test/scripts/332', 'main.py', '[]'::jsonb, 3, NOW());
